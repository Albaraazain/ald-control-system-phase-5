...
echo "   - ./scripts/start_parameter_control_ui.sh (Parameter control UI)"
echo "   - ./scripts/start_plc_tester.sh (PLC tester UI)"
echo "   - ./scripts/start_plc_debug.sh (Simple PLC debug UI)"
echo ""